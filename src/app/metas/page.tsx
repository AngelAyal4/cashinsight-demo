...
const GoalProgressChart = dynamic(
  () =>
    import('@/components/goals/goal-progress-chart').then((mod) => mod.GoalProgressChart),
  {
    ssr: false,
    loading: () => (
      <div
        className="relative h-32 w-32 shrink-0 animate-pulse bg-ink/10 sm:h-40 sm:w-40"
        aria-hidden="true"
      />
    ),
  }
