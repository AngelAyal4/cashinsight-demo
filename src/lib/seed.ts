...
/**
 * Crea (o completa) los datos de ejemplo de forma idempotente.
 *
 * Solo para desarrollo local: se invoca desde tests o desde el script explícito
 * `npm run seed:local`. No acepta datos de request y nunca se expone como ruta
 * HTTP de producción.
 */
